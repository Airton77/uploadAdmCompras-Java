package com.airtonmiranda.administracaocompras;
...
import com.airtonmiranda.administracaocompras.entities.Endereco;
...
import com.airtonmiranda.administracaocompras.entities.PagamentoCartao;
...
import com.airtonmiranda.administracaocompras.repositories.EnderecoRepository;
...
public class AdministracaoComprasApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(AdministracaoComprasApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoClienteE.PESSOA_FISICA);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/06/2020 10:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/05/2020 19:35"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoCartao(null, StatusPagamentoE.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoBoleto(null, StatusPagamentoE.PENDENTE, ped2, 
				sdf.parse("14/05/2020 00:00"), null);
